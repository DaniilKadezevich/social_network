            ...
            <div >
                <div className={`gender-wrapper d-flex justify-content-between  ${stateClass}`}>
                    <div onChange={this.handleChange} className="form-check form-check-inline m-0 ">
                        ...
                        <label className="form-check-label" htmlFor="regGenderM"><Translate value='application.form.gender.male'/></label>
                    </div>
                    <div onChange={this.handleChange} className="form-check form-check-inline m-0">
                        ...
                        <label className="form-check-label" htmlFor="regGenderF"><Translate value='application.form.gender.female'/></label>
                    </div>
                </div>
